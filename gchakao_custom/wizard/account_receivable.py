# gchakao_custom/wizard/account_receivable.py
...
class AccountReceivableWizard(models.TransientModel):
    ...
    _description = 'Asistente para imprimir Cuentas por Cobrar de un Cliente'
    ...
    def default_get(self, fields):
        res = super(AccountReceivableWizard, self).default_get(fields)
        user = self.env.user
    ...
    def _get_credit_notes_for_invoice(self, invoice):
        ...
        query = """
            SELECT 
                ...
                split_part(am.motive, ',', 2) AS credit_note_motive,
    ...
    def print_account_receivable(self):
        self.ensure_one()
        user = self.env.user
        sales_force_group = self.env.ref('gchakao_custom.group_sales_force_user')
        sales_force_manager_group = self.env.ref('gchakao_custom.group_sales_force_manager')
        ...
        return self.env.ref('gchakao_custom.action_report_account_receivable').report_action([], data=data)